<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="brand" :rules="rules" ref="brandFrom" label-width="150px">
      ...
      <el-form-item label="品牌官网网址：" >
        <el-input v-model="brand.webSite"></el-input>
      </el-form-item>
      <el-form-item label="品牌简介：">
        <el-input v-model="brand.brandDesc"></el-input>
      </el-form-item>
      ...
      <el-form-item style="text-align:center">
        ...
        <el-button type="info" v-if="!isEdit" @click="resetForm('brandFrom')">重置</el-button>
